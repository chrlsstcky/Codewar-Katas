...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
  let total = 0  
  let startingPriceOld = startPriceOld
  let startingPriceNew = startPriceNew
  let percentLossesByMonth = percentLossByMonth / 100 
  while(total < startingPriceNew){
    startingPriceNew = startingPriceNew - startingPriceNew * percentLossesByMonth 
    startingPriceOld = startingPriceOld - startingPriceOld * percentLossesByMonth 
    total += startingPriceOld + savingperMonth
  }
  return total 
}
